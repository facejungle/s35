...
export type TContentData = [ContentTitleType | ContentTextType | ContentRichTextType | ContentImageType | ContentGalleryType | ContentLocationType | ContentProjectType | ContentPortfolioType];